          ...
          <div className="layout-content-container flex flex-col max-w-[1200px] flex-1 overflow-y-auto">
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="px-4 py-3">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <p className="text-2xl font-bold text-[#121416]">
                          {formatNumber(analytics.summary.productsSold)}
                        </p>
                        <p className="text-xs text-[#6a7581] mt-1">
                          Total quantity
                        </p>
                ...
                {/* Order Trends and Order Status Breakdown */}
                <div className="px-4 py-3">
                          ...
                          {Object.entries(analytics.orderStatusBreakdown).map(([status, count]) => (
                            <div key={status} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                              <div className="flex-1">
                                <p className="font-medium text-[#121416] capitalize">
                                  {status}
                                </p>
                              </div>
                              <div className="text-right">
                                <p className="font-medium text-[#121416]">{formatNumber(count)}</p>
                              </div>
                            </div>
                          ))}
                        </div>
