...
export default function Home() {
  ...
  const getProductUrl = (product: Product) => {
    ...
    const categorySlug = categoryMap[product.category] || product.category.toLowerCase().replace(/\s+/g, '_');
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <div className="max-w-3xl">
            ...
            <p className="text-base md:text-lg mb-6 opacity-90 max-w-2xl">
              Find everything you need in one place. From fashion to electronics, 
              we've got you covered with quality products and unbeatable prices.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <section className="mb-16">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-3xl font-bold text-[#0d141c]">Featured Products</h2>
              <Link 
                href="/new-arrivals" 
          ...
          <section className="mb-16 bg-gradient-to-r from-[#FF0808] to-[#FF4040] rounded-2xl p-8 md:p-12 text-white relative overflow-hidden">
            ...
            <div className="relative max-w-4xl z-10">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Special Deals This Week</h2>
          ...
          {/* Top Categories Grid */}
          <section>
            <h2 className="text-3xl font-bold text-[#0d141c] mb-8">Top Categories</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
              {[
                { name: "Electronics", href: "/products/electronics", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuC10JIZ4Lq6592OOVhgEVVwX5G_n_xDsVT9mCmvagXYGDJmJxzY_IISHghtnMKsrzjm1mXYNgZXPf9C4SZnHq--S8_BHwVL-P-twAwkIXtCJt2dFXbCeU33PTEMC3VMYPA-Q8G3AJ3s496nccWuQHHxxCv5ZjlkV0g05teufUs_J_45BxwgYWT3jrNLCrOpDNJeHIIIfWlGyqZKxF0rVTyIATf2K4Xw3udVgXsakVkfUt1f2XwieUNEfW4ll2JzfjY0MwMkCgqdIZ4" },
                { name: "Fashion", href: "/products/fashion", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBCbXXl0RyGeZ18lveDjSFVxYjtkdbuH_wktEWd7L6EbznWe7pPAVfmqjqRP2ZFXdTvL9vH3Yfc6jEOaBcoiNs-7IpmuZN_JN4ZKWLetpNqo7gjUhN7REb05opFadPckY8yA1qguH4v5hx2OvPJJ8FZpBcC35KPG9g9tiNbUz0gJxtWcp2-Z4bg5yY8l7JeWQvqwsBDcZc5waHazI4rb4sKyqgYTy_jXIbWuqW0Tgb_RdvyGN_mgH7IYHioecqy9U2qUJJCLwux7AQ" },
                { name: "Home & Kitchen", href: "/products/home_and_living", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCsIcNyI_DmMvaGSuM298RT3mS-VvQuQ2w6FP3da0bQpAlevotafsda1Orb60Cr7YmwXg594hdIHFwYT_C9Kj9F72VhTn0zplmeML1hDOs-JwSJb7Jmd2a_gmQBgJbtjKRkUzqMxjeq9RfmF6HzZ3Z2bj6_cAG_n5r0CoZ3mF9iPvx-4MVXV4rQB6zmT3doc-0gz6yF0jeSMtixaTu-zjiGPU4AkmXR8TmzbDvBXSdiuOpasVrLgFdQA5LV9ot7beoUnvL6eEvuZ9g" },
                { name: "Books", href: "/products/books", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuC10JIZ4Lq6592OOVhgEVVwX5G_n_xDsVT9mCmvagXYGDJmJxzY_IISHghtnMKsrzjm1mXYNgZXPf9C4SZnHq--S8_BHwVL-P-twAwkIXtCJt2dFXbCeU33PTEMC3VMYPA-Q8G3AJ3s496nccWuQHHxxCv5ZjlkV0g05teufUs_J_45BxwgYWT3jrNLCrOpDNJeHIIIfWlGyqZKxF0rVTyIATf2K4Xw3udVgXsakVkfUt1f2XwieUNEfW4ll2JzfjY0MwMkCgqdIZ4" },
                { name: "Sports", href: "/products/sports_and_outdoors", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBCbXXl0RyGeZ18lveDjSFVxYjtkdbuH_wktEWd7L6EbznWe7pPAVfmqjqRP2ZFXdTvL9vH3Yfc6jEOaBcoiNs-7IpmuZN_JN4ZKWLetpNqo7gjUhN7REb05opFadPckY8yA1qguH4v5hx2OvPJJ8FZpBcC35KPG9g9tiNbUz0gJxtWcp2-Z4bg5yY8l7JeWQvqwsBDcZc5waHazI4rb4sKyqgYTy_jXIbWuqW0Tgb_RdvyGN_mgH7IYHioecqy9U2qUJJCLwux7AQ" },
                { name: "Beauty", href: "/products/beauty_and_personal_care", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCsIcNyI_DmMvaGSuM298RT3mS-VvQuQ2w6FP3da0bQpAlevotafsda1Orb60Cr7YmwXg594hdIHFwYT_C9Kj9F72VhTn0zplmeML1hDOs-JwSJb7Jmd2a_gmQBgJbtjKRkUzqMxjeq9RfmF6HzZ3Z2bj6_cAG_n5r0CoZ3mF9iPvx-4MVXV4rQB6zmT3doc-0gz6yF0jeSMtixaTu-zjiGPU4AkmXR8TmzbDvBXSdiuOpasVrLgFdQA5LV9ot7beoUnvL6eEvuZ9g" },
              ].map((category) => (
                <Link
                  key={category.name}
                  href={category.href}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-white/90">
                <li><Link href="/customer-service" className="hover:text-white transition-colors">Help Center</Link></li>
