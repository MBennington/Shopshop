...
// Mock shops/products (copy from search page)
const shops = [
  {
    id: '1',
    name: 'Urban Styles',
  ...
  return (
    <div className="min-h-screen bg-white py-10 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {wishlisted.length === 0 ? (
          <div>
            <div className="text-center text-[#6c757f] text-lg py-8">Your wishlist is empty. Start exploring and add products you love!</div>
