...
router
  .route(permissions.getAllOrders.path)
  .get(
    validator.validateHeader(permissions.getAllOrders.grantedUserRoles),
    validator.validateQueryParameters(schema.getAllOrders),
